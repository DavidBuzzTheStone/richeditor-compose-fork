...
internal class RichSpan(
     ...
     */
    fun isEmpty(): Boolean = text.isEmpty() && isChildrenEmpty() && richSpanStyle !is RichSpanStyle.Image && richSpanStyle !is InlineContentSpanStyle
     ...
     */
    fun isBlank(): Boolean = text.isBlank() && isChildrenBlank() && richSpanStyle !is RichSpanStyle.Image && richSpanStyle !is InlineContentSpanStyle
    ...
    internal fun trimStart(): Boolean {
        if (richSpanStyle is RichSpanStyle.Image || richSpanStyle is InlineContentSpanStyle)
            return false
    ...
    internal fun trimEnd(): Boolean {
        val isImage = richSpanStyle is RichSpanStyle.Image || richSpanStyle is InlineContentSpanStyle
